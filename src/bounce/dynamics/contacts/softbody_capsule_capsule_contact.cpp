...
void b3SoftBodyCapsuleAndCapsuleContact::Update()
{
	m_active = false;

	b3SoftBodyParticle* p1 = m_s1->m_p1;
	b3SoftBodyParticle* p2 = m_s1->m_p2;
	b3SoftBodyParticle* p3 = m_s2->m_p1;
	b3SoftBodyParticle* p4 = m_s2->m_p2;
