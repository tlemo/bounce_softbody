...
void b3SoftBodyShearForceDef::Initialize(const b3Vec3& A, const b3Vec3& B, const b3Vec3& C)
{
	b3Vec3 AB = B - A;
	b3Vec3 AC = C - A;
...
b3SoftBodyShearForce::b3SoftBodyShearForce(const b3SoftBodyShearForceDef* def)
{
	m_type = e_softBodyShearForce;
