...
b3SoftBodyTetrahedronElementForce::b3SoftBodyTetrahedronElementForce(const b3SoftBodyTetrahedronElementForceDef* def)
{
	m_type = e_softBodyTetrahedronElementForce;
...
void b3SoftBodyTetrahedronElementForce::ResetElementData()
{
...
void b3SoftBodyTetrahedronElementForce::ComputeForces(const b3SparseForceSolverData* data)
{
