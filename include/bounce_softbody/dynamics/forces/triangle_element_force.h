...
#ifndef B3_TRIANGLE_ELEMENT_FORCE_H
#define B3_TRIANGLE_ELEMENT_FORCE_H

#include <bounce_softbody/dynamics/forces/force.h>
#include <bounce_softbody/common/math/mat22.h>
...
struct b3TriangleElementForceDef : public b3ForceDef
{
	b3TriangleElementForceDef()
	{
		type = e_triangleElementForce;
...
inline void b3TriangleElementForce::SetStiffnessDamping(scalar damping)
{
	B3_ASSERT(damping >= scalar(0));
	m_stiffnessDamping = damping;
}

inline scalar b3TriangleElementForce::GetStiffnessDamping() const
{
